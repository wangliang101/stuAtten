...
<div class="body-l">
    ...
    <div class="body-l-b">
        <table>
            <tr><td><a href="index.php">个人中心</a></td></tr>
            <tr><td><a href="stu-xg.php">修改信息</a></td></tr>
...
<?php
//对提交的数据进行修改
if (isset($_GET['upass'])&&$_GET['upass']!=""&&isset($_GET['maj'])&&$_GET['maj']!=""&&isset($_GET['class'])&&$_GET['class']!=""){
    $upass=$_GET['upass'];
    $maj=$_GET['maj'];
    $class=$_GET['class'];
    include "conn.php";
    mysql_selectdb("stu");
    mysql_query("UPDATE `stu` SET  `upass` = '".$upass."', `maj` = '".$maj."', `class` = '".$class."' WHERE `stu`.`id` =".$_GET['fid']);
